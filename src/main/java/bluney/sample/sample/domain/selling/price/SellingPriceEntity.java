...
public @ToString @NoArgsConstructor @AllArgsConstructor class SellingPriceEntity {
	@Id
	@GeneratedValue(strategy=GenerationType.AUTO, generator="SEQ_SELLING_PRICE_PK_SYNC")
	...
	private @Getter @Setter @NotNull Double value;			// 매매 가격			
}